...
echo -e "$green.........................................................."$NC
echo -e "$Lyellow                  Autoscript By XLORD × NIELA"$NC
echo -e "$Lyellow                    CONTACT TELEGRAM"$NC
echo -e "$Lyellow                       @xlordeuyy"$NC
echo -e "$green.........................................................."$NC
echo ''
...
VALIDITY() {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/${GitUser}/allow/main/ipvps.conf | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
        echo -e "\e[32mLicensi Aktif @xlordeuyy\e[0m"
        sleep 5
    else
        echo -e "\e[31mYOUR SCRIPT HAS EXPIRED!\e[0m"
        echo -e "\e[31mPlease renew your ipvps first\e[0m"
...
echo " "
echo -e "\e[1;32m══════════════════SC PREMIUM XLORD══════════════════\e[0m" | tee -a log-install.txt
...
echo -e "\e[1;32m══════════════════Autoscript By Xlord══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|         Premium By Xlord             |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
