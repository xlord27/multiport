...
adminip=$( curl -sS https://raw.githubusercontent.com/xlord27/allow/main/adminipvps | grep $MYIP )
...
sleep 1
cek=$( curl -sS https://raw.githubusercontent.com/xlord27/allow/main/ipvps.conf | awk '{print $5}' | grep $daftar )
if [[ $daftar = $cek ]]; then
...
git clone https://github.com/xlord27/allow.git
mkdir /root/allow
cd /root/allow/
rm -rf .git
git init
...
git branch -M main
git remote add origin https://github.com/xlord27/allow.git
git push -f https://${tokengit}@github.com/xlord27/allow.git
